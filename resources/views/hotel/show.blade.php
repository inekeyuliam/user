    ...
    <div class="page">
      ...
      <header class="section page-header breadcrumbs-custom-wrap bg-gradient bg-secondary-2 novi-background bg-cover">
        ...
        <section class="breadcrumbs-custom" style="background: url(&quot;images/backgroundhasil.png&quot;); background-size: cover;">
          <div class="container">
            <h1 class="breadcrumbs-custom-subtitle">Detail Hotel</h1>
          </div>
        </section>
      </header>
        ...
        <div class="container container-wide">
          <div class="row row-fix row-50 row-custom-bordered">
            ...
            <div class="col-sm-6 col-lg-3">
              ...
              <article class="box-simple">
                ...
                <div class="box-simple-text">
                  <ul class="list-comma list-0">
                  @if($list['link_ig'] == '')
                  <li class="icon mdi mdi-facebook"><a href="{{$list['link_fb']}}"> {{$list['nama_hotel']}} </a></li>
                  @else
                    <li class="icon mdi mdi-facebook"><a href="{{$list['link_fb']}}"> {{$list['nama_hotel']}} </a></li>
                    <li class="icon mdi mdi-instagram"><a href="{{$list['link_ig']}}"> {{$list['nama_hotel']}} </a></li>
                  @endif
                  </ul>
                </div>
              </article>
            ...
            <div class="col-sm-6 col-lg-3">
              <!-- Box simple-->
              <article class="box-simple">
                <div class="box-simple-icon novi-icon mdi mdi-star"></div>
                <h6>Bintang</h6>
                <div class="box-simple-text">
                  <ul class="list-0">
                    <li>Hotel Bintang {{$list['bintang']}}</li>
            ...
            <div class="row row-fix row-50">
              <div class="col-lg-8 col-xl-7">
                <div class="section-wrap-content section-lg">
                  ...
                  <!-- RD Mailform-->
                  <form class="rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="{{url('review/hotel/'.$list['id'])}}">
